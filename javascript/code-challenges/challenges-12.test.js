...
const replaceZeros = (string) => {
  ...
  let replacement = 'zero' ;
   let output =string.replace(  pattern , replacement) ;
...
Note: if you ever need to validate an email using a regex in practice, the Internet has 
the actual regex you should use. It's many many lines long.
------------------------------------------------------------------------------------------------ */
