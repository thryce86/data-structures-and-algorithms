...
Write a function name d notInFirstArray that, given two arrays as input, 
...
const notInFirstArray = (forbiddenValues, arr) => {
  ...
  let output = arr.filter(( temp ,  i) => {

    // console.log( 'a= ' + a +  'b= ' +b );
    // return(b != a) ;
    return( arr[i] != forbiddenValues[i]) ;
